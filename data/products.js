...
// product is key oject of products . and product itself is a class having pro and methods

// console.log(this);// this is undefined here as it is a module otherwise it for window
...
// const obj={
//   a:2,
//   b:this.a// this: here it is undefined(this key word) and so b cant read property of undefined
// }

// console.log(obj.b); her b is not 
...
logthis();// here this key word is undefined
logthis.call('this value assign to this key word');
// logthis.call('hellow',par1,par2);

// arrow function dont change value of key(this) so this hold undefined same as before
...
obj1.method.call();// give undefined 
obj1.method.call('hellow');//give undefined

const obj2={
  method (){
    console.log('this key value in method using regular',this);
  }
}

obj2.method();// this: its point to object here

// if in a method we define a new function (regular) it changes the value 
// of key this according to the envirnment and dont keep it equal to org object 
// and lost the obj but if we define arrow function it holds this as in the method (obj2)

const obj3={
  method (){
    console.log(this);
      [3,4,6,3].forEach(()=>{
        console.log('same as above dont loose object',this);
      })
  }
}
